...
setwd("C:/Users/lukad/OneDrive/Documents/GitHub/StatsII_2026/tutorials/Week 2 - Copy")
getwd()
...
## loading the data
data_raw <- readxl::read_xlsx("cbg_turnover_v23upload.xlsx")
...
mean(data$regular_turnover, by = data$country)
?mean
